...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "Course",
      "@id": "https://www.cryptocipheracademy.com/live-sound-engineering-course#course",
      "name": "Live Sound Engineering Course",
      "url": "https://www.cryptocipheracademy.com/live-sound-engineering-course",
      "description": "Hands-on training in live audio mixing, FOH systems, stage monitoring, and PA systems. Learn event sound management with real-world gear.",
      "provider": {
        "@type": "Organization",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.cryptocipheracademy.com/live-sound-engineering-course#faq",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is taught in the Live Sound Engineering Course?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The course includes live mixing, FOH setup, microphones, cabling, and stage monitoring."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "It is open to anyone interested in live sound management, even without prior experience."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "You can work as a live sound engineer, FOH technician, or stage audio manager."
          }
        },
        {
          "@type": "Question",
          "name": "Is practical training included in the course?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, you receive hands-on training using pro gear during real events."
          }
        },
        {
          "@type": "Question",
          "name": "Does the course provide a certificate?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, a recognized certificate is awarded by Crypto Cipher® Academy upon completion."
          }
        }
      ]
    }
        ...
        <div class="row px-3 media-px-2">
            ...
            <div class="col-md-6 my-2 pt-3">
                <div class="slider-header bg-theme p-4" align="left">
                    <h4 class="font-black text-black font-18">Who Can Enroll Live Sound Engineering Course?</h4>
