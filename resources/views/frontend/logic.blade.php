...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "Course",
      "@id": "https://www.cryptocipheracademy.com/music-production-course#course",
      "name": "Music Production Course",
      "url": "https://www.cryptocipheracademy.com/music-production-course",
      "description": "Short-term music production course in Delhi. Learn DAWs, sound design, mixing, and arrangement in a professional studio.",
      "provider": {
        "@type": "Organization",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.cryptocipheracademy.com/music-production-course#faq",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is the duration of the music production course?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The short-term course lasts for 3 months, focusing on practical and technical skills in music production."
          }
        },
        {
          "@type": "Question",
          "name": "Do I need any prior experience to join this course?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No prior experience is required. The course is beginner-friendly and covers basic to advanced techniques."
          }
        },
        {
          "@type": "Question",
          "name": "Which software or DAWs are taught in this course?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We cover industry-standard DAWs such as Ableton Live and Logic Pro X."
          }
        },
        {
          "@type": "Question",
          "name": "Where is this course conducted?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The course is offered in-studio at our Delhi campus with personalized mentorship and professional equipment."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "You can use your skills as a music producer, beatmaker, mixing/mastering engineer, or composer for media."
          }
        }
      ]
    }
...
<div class="bg-theme1 main-inner">
    <section class="container slider-header mb-4">
        <!-- title -->
        <div class="px-3 pt-4 media-pt-0">
            <h1 class="font-regular text-grey2 pl-2 pb-0 font-13 inner-title">LOGIC PRO X & ABLETON LIVE</h1>
            ...
            <div class="col-md-6 my-2">
                <div class="" align="left">
                    ...
                    <div class="mobile-center">
                        <a href="{{url('register')}}">
                            <div class="font-regular mb-2 mt-4 page-12-btn" id="logic">
                                APPLY NOW
                            </div>
                        </a>
                    </div>
    ...
    <section class="container slider-header mb-4 px-3">
        <!-- title -->
    ...
    <section class="container slider-header px-3">
        <!-- title -->
        <div class="px-2 pt-4 pl-0">
