 ...
 <table class="table table-striped">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="{{ route('admin.faqHostel.edit',$row->id)}}">
            <i class="material-icons">edit</i>
          </a>
        </td>
        <td>
          <form action="{{ route('admin.faqHostel.destroy', $row->id)}}" method="post">
            @csrf
            @method('DELETE')
...
@else
<h3 class="bold text-dark" align="center">No FAQ about Hostel</h3>
@endif

<div align="right" style="position: fixed;bottom: 30px;right: 30px;">
  <a href="{{ route('admin.faqHostel.create')}}">
    <button class="btn px-5 pt-3" style="background: #1d1b27;color:#fff;">Add new FAQ Hostel 
