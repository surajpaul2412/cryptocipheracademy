...
<div class="card uper">
  <div class="card-header">
    <h3 class="heading">Edit Music Production Diploma Content</h3>
  </div>
  <div class="card-body">
    @if ($errors->any())
    ...
    @endif
      <form method="post" action="{{ route('admin.musicProductionDiploma.update', $musicProductionDiploma->id) }}" enctype="multipart/form-data">
        @method('PATCH')
        @csrf
