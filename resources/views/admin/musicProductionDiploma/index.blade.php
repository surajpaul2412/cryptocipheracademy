...
<div class="table-responsive px-3 pb-5">
 <table class="table table-striped">
    <thead>
        <tr>
          <th>Music Production Diploma Course</th>
        </tr>
    </thead>
    <tbody>
        <tr>
...
<div align="right" style="position: fixed;bottom: 30px;right: 30px;">
  <a href="{{ route('admin.musicProductionDiploma.edit',$row->id)}}">
    <button class="btn px-5 pt-3" style="background: #1d1b27;color:#fff;">Edit Music Production Diploma
