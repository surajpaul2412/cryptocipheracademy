...
<div class="card uper">
  <div class="card-header">
    <h3 class="heading">Add Fast Forward FAQ</h3>
  </div>
  <div class="card-body">
    @if ($errors->any())
    ...
    @endif
      <form method="post" action="{{ route('admin.fastForwardFaq.store') }}">
          @csrf
          ...
          <button type="submit" class="btn btn-primary">Add Fast Forward FAQ</button>
      </form>
  </div>
</div>
