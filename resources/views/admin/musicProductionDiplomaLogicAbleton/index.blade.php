...
@if($musicProductionDiplomaLogicAbleton->count())
<div class="table-responsive px-3 pb-5">
  <table class="table table-striped">
    ...
    <tbody>
      <tr>
        @foreach($musicProductionDiplomaLogicAbleton as $row)
          <td>{!! $row->content !!}</td>
        @endforeach
      </tr>
    </tbody>
...
<div align="right" style="position: fixed; bottom: 30px; right: 30px;">
  <a href="{{ route('admin.musicProductionDiplomaLogicAbleton.edit', $row->id) }}">
...
@else
  <h3 class="bold text-dark" align="center">No content exists, please add some.</h3>
@endif
@endsection
